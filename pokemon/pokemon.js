...
let pokemonMaster = {
    id: 1,
      name: "new", 
      created_date:"17 noviembre 2001", 
     pokemon:[] 
}

console.log (pokemonMaster);
console.log(pokemonMaster.length);
...
function addRandomPokemon(){
    ...
    pokemonMaster.pokemons.push(pokemons[aleatorio])
    console.log(pokemonMaster)
}
...
console.log (pokemonTop);
console.log(pokemonTop.length);

console.log(); 

function addTopPokemon(){
    const aleatorio = Math.floor(Math.random()*pokemons.length)
